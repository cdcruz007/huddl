  ...
  List<_EventTemplate> _allTemplates(String borough) {
    return [
      _EventTemplate(
        ...
        source: const EventSource(name: 'Council Website', icon: HuddlIcons.bank),
      ...
      _EventTemplate(
        ...
        source: const EventSource(name: 'Eventbrite', icon: HuddlIcons.ticket),
      ...
      _EventTemplate(
        ...
        icon: HuddlIcons.brush,
        organiserTemplate: 'Little Messy Ones',
        imageUrl: 'https://images.pexels.com/photos/8535216/pexels-photo-8535216.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Facebook Events', icon: HuddlIcons.facebook),
      ...
      _EventTemplate(
        ...
        color: HuddlColors.nearBlack,
        icon: HuddlIcons.wellness,
        organiserTemplate: 'Bloom Yoga {borough}',
        imageUrl: 'https://images.pexels.com/photos/4473612/pexels-photo-4473612.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'ClassPass', icon: HuddlIcons.fitness),
      ...
      _EventTemplate(
        ...
        imageUrl: 'https://images.pexels.com/photos/5791027/pexels-photo-5791027.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Meetup.com', icon: HuddlIcons.usersThree),
      ...
      _EventTemplate(
        ...
        imageUrl: 'https://images.pexels.com/photos/6671008/pexels-photo-6671008.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Eventbrite', icon: HuddlIcons.ticket),
      ...
      _EventTemplate(
        ...
        isFree: true,
        color: HuddlColors.primary,
        icon: HuddlIcons.shoppingBag,
        organiserTemplate: 'NCT {borough}',
        imageUrl: 'https://images.pexels.com/photos/7282428/pexels-photo-7282428.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'NCT Website', icon: HuddlIcons.childFriendly),
      ...
      _EventTemplate(
        ...
        isFree: true,
        color: HuddlColors.nearBlack,
        icon: HuddlIcons.coffee,
        organiserTemplate: 'DadPad {borough}',
        imageUrl: 'https://images.pexels.com/photos/8763020/pexels-photo-8763020.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Facebook Events', icon: HuddlIcons.facebook),
      ...
      _EventTemplate(
        ...
        imageUrl: 'https://images.pexels.com/photos/3662851/pexels-photo-3662851.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'NHS Website', icon: HuddlIcons.medical),
      ...
      _EventTemplate(
        ...
        color: HuddlColors.primary,
        icon: HuddlIcons.gymnastics,
        organiserTemplate: 'Jump & Tumble {borough}',
        imageUrl: 'https://images.pexels.com/photos/8535225/pexels-photo-8535225.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Google Maps', icon: HuddlIcons.map),
      ...
      _EventTemplate(
        ...
        isFree: true,
        color: HuddlColors.primaryDark,
        icon: HuddlIcons.pregnant,
        organiserTemplate: '{borough} Maternity Services',
        imageUrl: 'https://images.pexels.com/photos/7088531/pexels-photo-7088531.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'NHS Website', icon: HuddlIcons.medical),
      ...
      _EventTemplate(
        ...
        color: HuddlColors.primary,
        icon: HuddlIcons.musicNote,
        organiserTemplate: 'Jo Jingles {borough}',
        imageUrl: 'https://images.pexels.com/photos/8535228/pexels-photo-8535228.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Jo Jingles', icon: HuddlIcons.musicNote),
      ...
      _EventTemplate(
        ...
        isFree: true,
        color: HuddlColors.primary,
        icon: HuddlIcons.tree,
        organiserTemplate: '{borough} Rangers',
        imageUrl: 'https://images.pexels.com/photos/14096103/pexels-photo-14096103.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Council Website', icon: HuddlIcons.bank),
      ...
      _EventTemplate(
        ...
        isOnline: true,
        color: HuddlColors.nearBlack,
        icon: HuddlIcons.restaurant,
        organiserTemplate: 'First Bites Nutrition',
        imageUrl: 'https://images.pexels.com/photos/5593072/pexels-photo-5593072.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Eventbrite', icon: HuddlIcons.ticket),
        locationSuffix: 'Zoom',
      ...
      _EventTemplate(
        ...
        icon: HuddlIcons.theater,
        organiserTemplate: 'Little Angel Theatre',
        imageUrl: 'https://images.pexels.com/photos/7356472/pexels-photo-7356472.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Timeout', icon: HuddlIcons.article),
      ...
      _EventTemplate(
        ...
        source: const EventSource(name: 'Adoption UK', icon: HuddlIcons.heart),
        locationSuffix: 'Country Park',
      ...
      _EventTemplate(
        ...
        source: const EventSource(name: 'Gingerbread', icon: HuddlIcons.volunteerActivism),
        locationSuffix: 'Arts Centre',
      ...
      _EventTemplate(
        ...
        imageUrl: 'https://images.pexels.com/photos/8535230/pexels-photo-8535230.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Home for Good', icon: HuddlIcons.home),
      ...
      _EventTemplate(
        ...
        isFree: false, price: '\u00A310',
        color: HuddlColors.nearBlack,
        icon: HuddlIcons.family,
        organiserTemplate: 'Care for the Family',
        imageUrl: 'https://images.pexels.com/photos/8550834/pexels-photo-8550834.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Care for the Family', icon: HuddlIcons.usersThree),
      ...
      _EventTemplate(
        ...
        source: const EventSource(name: 'Family Fund', icon: HuddlIcons.heartFill),
      ...
      _EventTemplate(
        ...
        imageUrl: 'https://images.pexels.com/photos/8363103/pexels-photo-8363103.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Parentkind', icon: HuddlIcons.howToVote),
      ...
      _EventTemplate(
        ...
        source: const EventSource(name: 'Sibs', icon: HuddlIcons.usersThree),
      ...
      _EventTemplate(
        ...
        source: const EventSource(name: 'Coram Family Lives', icon: HuddlIcons.support),
      ...
      _EventTemplate(
        ...
        imageUrl: 'https://images.pexels.com/photos/8363769/pexels-photo-8363769.jpeg?auto=compress&cs=tinysrgb&w=600',
        source: const EventSource(name: 'Barnardo\u2019s', icon: HuddlIcons.shieldCheck),
        locationSuffix: 'Community Centre',
